...
def _build_system_prompt() -> str:
    return (
        ...
        "4. If the Character Name already appears in the position descriptor "
        "(e.g., 'the character behind is oreki houtarou'), do NOT repeat it "
        "at the end of Part 1. The name in the position phrase IS sufficient.\n"
        "\n"
        ...
        "5. For characters described as 'out of frame', 'ghost', 'silhouette', "
        "or otherwise partially visible/invisible, MINIMIZE outfit description — "
        "only describe what would actually be visible in the image.\n"
        "\n"
        ...
        "- CRITICAL SCENE PRESERVATION: Do NOT change the location, setting, "
        "or scene composition. Only remove filler/quality tags and atmosphere words. "
        "'interior, security room' stays 'interior, security room' regardless of Chat.\n"
        ...
        "- CRITICAL SCENE PRESERVATION: The Supplement describes the VISUAL SCENE "
        "shown in the image. You MUST preserve the original scene — do NOT change "
        "the location, setting, characters present, or spatial relationships based "
        "on Chat context. Chat provides emotional/expressive context only, "
        "NOT scene description. 'security room with monitors' stays 'security room "
        "with monitors' even if Chat describes a street escape.\n"
        "- MULTI-CHARACTER SCENES: When Setup contains multi-character tags "
        "(1girl 1boy, 2girls, etc.), the Supplement MUST describe the OVERALL "
        "scene composition including ALL characters and their spatial relationships, "
        "not just the target character.\n"
        "\n"
        "### OUTPUT FORMAT\n"
